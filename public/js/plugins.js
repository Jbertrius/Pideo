    ...
    var uiElements = function(){
        ...
        var uiScroller = function(){
            ...
            if($("#messageList").length > 0){
                $("#messageList").mCustomScrollbar({axis:"y", autoHideScrollbar: true, scrollInertia: 0, advanced: {autoScrollOnFocus: false, updateOnContentResize: false,
                    updateOnImageLoad: false, updateOnSelectorChange: "string"}});
            }

            if($(".scroll").length > 0){
                $(".scroll").mCustomScrollbar({axis:"y", autoHideScrollbar: true, scrollInertia: 0, advanced: {autoScrollOnFocus: false}});
            }
