	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand brand" href= {{ URL::to('/') }}><img src="{{asset('img/logo.png')}}" style="margin-top: -10px;"></a>
	...
	<footer>
		<div class="container">
			...
			<div class="row bottom-footer text-center-mobile">
				...
				<div class="col-sm-8">
					<p>&copy; 2016 All Rights Reserved. Powered by <a href="http://www.piideo.com/">Piideo</a> </p>
				</div>

				<div class="col-sm-4 text-right text-center-mobile">

					<ul class="social-footer">
						<li><a href="https://www.facebook.com/Pideomewebsite"><i class="fa fa-facebook"></i></a></li>
